...
public class RippleImageView extends RelativeLayout {
    ...
    private static final int IMAGEVIEW_SIZE = 80;
    /**
     * 三张波纹图片
     */
     ...
     * 水波纹和背景图片的大小
     */
    private float imageViewWidth = IMAGEVIEW_SIZE;
    private float imageViewHeight = IMAGEVIEW_SIZE;
    ...
    private void getAttributeSet(Context context, AttributeSet attrs) {
        ...
        imageViewWidth = typedArray.getDimension(R.styleable.custume_ripple_imageview_imageViewWidth, IMAGEVIEW_SIZE);
        imageViewHeight = typedArray.getDimension(R.styleable.custume_ripple_imageview_imageViewHeigth, IMAGEVIEW_SIZE);
        Log.d("TAG", "show_spacing_time=" + show_spacing_time + "mm imageViewWidth=" + imageViewWidth + "px  imageViewHeight=" + imageViewHeight + "px");
        typedArray.recycle();
    }
    ...
    private void setLayout(Context context) {
        ...
        LayoutParams params_bg = new LayoutParams(dip2px(context, imageViewWidth) + 10, dip2px(context, imageViewHeight) + 10);
        //添加一个规则
